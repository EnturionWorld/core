...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        Kitron::AnyUnitInObjectRangeCheck go_check(object, radius);
        Kitron::CreatureListSearcher<Kitron::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
